...
function(hfc_genex_eval_read_resolved dir base out_var)
    set(_result "")
    foreach(_lang c cxx)
        set(_dump_file "${dir}/${base}_${_lang}.txt")
        if(EXISTS "${_dump_file}")
            file(STRINGS "${_dump_file}" _lines)
...
# variables or HERMETIC_FETCHCONTENT_ADDITIONAL_TOOLCHAIN_FINGERPRINT_VARIABLES that are
