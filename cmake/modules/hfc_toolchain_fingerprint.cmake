...
# - HERMETIC_FETCHCONTENT_ADDITIONAL_TOOLCHAIN_FINGERPRINT_VARIABLES  / global list of extra vars
#
...
function(compute_live_toolchain_fingerprint out_var)
    ...
    if(NOT HERMETIC_FETCHCONTENT_TOOLCHAIN_FINGERPRINT_DISABLE_CAPTURE_TOP_LEVEL_DIR_PROPERTIES)
    ...
    set(extra_vars ${HERMETIC_FETCHCONTENT_ADDITIONAL_TOOLCHAIN_FINGERPRINT_VARIABLES})
        ...
        foreach(extra_var IN LISTS extra_vars)
            ...
            if(extra_var MATCHES "^ENV\\{(.+)\\}$")
                ...
                if(DEFINED ENV{${env_name}})
                    string(APPEND toolchain_state "ENV_${env_name}=$ENV{${env_name}}\n")
                else()
                    string(APPEND toolchain_state "ENV_${env_name}//NOTFOUND\n")
                endif()
            else()
...
function(compute_augmented_toolchain_fingerprint_isolated out_var)
    ...
    set(extra_vars ${FN_ARG_ADDITIONAL_VARIABLES} ${HERMETIC_FETCHCONTENT_ADDITIONAL_TOOLCHAIN_FINGERPRINT_VARIABLES} ${HERMETIC_FETCHCONTENT_FORWARDED_CMAKE_VARIABLES})
