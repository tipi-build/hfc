...
function(generate_autotools_cmake_adapter destination PROJECT_NAME PROJECT_SOURCE_DIR PROJECT_INSTALL_PREFIX)
  set(options_params)
  set(one_value_params HERMETIC_CONFIG_LANGUAGE)
...
function(hfc_autotools_restore_or_configure content_name)
  ...
  if (NOT EXISTS "${FN_ARG_HFC_CONFIGURE_MARKER_FILE}")
    cmake_language(CALL ${FN_ARG_CMAKE_ADAPTER_GENERATOR_FN} ${autotools_cmake_adapter_destination} ${content_name} ${FN_ARG_PROJECT_BINARY_DIR} ${FN_ARG_PROJECT_INSTALL_PREFIX} HERMETIC_CONFIG_EXTRA_ARGS ${FN_ARG_HERMETIC_CONFIG_EXTRA_ARGS} HERMETIC_CONFIG_LANGUAGE ${FN_ARG_HERMETIC_CONFIG_LANGUAGE})
  endif()
