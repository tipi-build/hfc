...
macro(hfc_provide_dependency_FINDPACKAGE method content_name)
  ...
  if("${package_found}" AND (NOT "${FORCE_SYSTEM_${package_name}}"))
    ...
    # After consume, version may have been auto-detected and registered.
    # Re-read it if we don't already have it from the provider registry.
    ...
    # Set common _LIB / _STATIC_LIB aliases (used by projects like Arrow's ThirdpartyToolchain)
    if(libraries_len GREATER_EQUAL 1)
      list(GET package_LIBRARIES 0 _hfc_first_lib)
      set(${package_name_uppercase}_LIB "${_hfc_first_lib}")
      set(${package_name_uppercase}_STATIC_LIB "${_hfc_first_lib}")
    endif()

    # Set VERSION from the registered target cache info
