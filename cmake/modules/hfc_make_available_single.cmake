...
function(hfc_make_available_single content_name build_at_configure_time)
  ...
  if (DEFINED FORCE_SYSTEM_${content_name})
    if (${FORCE_SYSTEM_${content_name}})
      ...
      message(WARNING "XXXXX " "${proxy_toolchain_args}")
      file(READ ${proxy_toolchain_path} tccontent)
      message(WARNING "XXXXX " "${tccontent}")
      ...
      file(READ ${target_cache_file} targccontent)
      message(WARNING "XXXXX " "${targccontent}")
