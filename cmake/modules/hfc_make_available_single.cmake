...
function(hfc_make_available_single content_name build_at_configure_time)
  ...
  set(one_value_params
    ...
    HERMETIC_DECLARED_PACKAGE_VERSION
  ...
  if(__PARAMS_HERMETIC_DECLARED_PACKAGE_VERSION)
    set(HERMETIC_FETCHCONTENT_${content_name}_VERSION "${__PARAMS_HERMETIC_DECLARED_PACKAGE_VERSION}" CACHE INTERNAL "User-specified hermetic dependency version for ${content_name}" FORCE)
  endif()
