...
macro(hfc_provide_dependency_FIND_PACKAGE method content_name)
  ...
  if("${package_found}" AND (NOT "${FORCE_SYSTEM_${package_name}}"))
    ...
    foreach(target IN LISTS imported_libraries)
      ...
      if(tgt_include_dirs)
        set(filtered_tgt_include_dirs "")
        foreach(dir IN LISTS tgt_include_dirs)
          if(NOT dir MATCHES "-NOTFOUND$")
            list(APPEND filtered_tgt_include_dirs "${dir}")
          endif()
        endforeach()
        if(filtered_tgt_include_dirs)
          list(APPEND package_INCLUDE_DIRS ${filtered_tgt_include_dirs})
        endif()
      endif()

      # link libraries
      get_target_property(tgt_location ${target} LOCATION)
      if(tgt_location AND NOT tgt_location MATCHES "-NOTFOUND$")
